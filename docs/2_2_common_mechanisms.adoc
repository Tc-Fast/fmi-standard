...
[[fmi3Fatal,`fmi3Fatal`]]
`fmi3Fatal`::
The state machine mode of all instances of the model is irreparably corrupted.
...
* latexmath:[\mathbf{v}_{\mathit{unknown}}] is the vector of unknown variables computed in the current state machine mode:
