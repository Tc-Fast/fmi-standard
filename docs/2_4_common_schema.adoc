...
_[The importer should not rely on self-dependencies to be explicitly listed, e.g., <<Output>>s that are continuous-time state(s) have an implicit self-dependency.]_
