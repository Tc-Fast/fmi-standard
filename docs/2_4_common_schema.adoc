...
|[[providesPerElementDependencies,`providesPerElementDependencies`]]If `true`, the FMU is able to provide detailed dependency information at runtime using <<fmi3GetNumberOfVariableDependencies>> and <<fmi3GetVariableDependencies>>.
