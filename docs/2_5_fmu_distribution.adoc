...
In addition to the `<arch>` and `<sys>` names standardized below, further names are standardized in the link:../PLATFORM_REGISTRY.md[FMI Platform Tuple Registry].

NOTE: The FMI Platform Tuple Registry is updated independently of this specification's release cycle.
